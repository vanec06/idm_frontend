...
const Home = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const usuariosResponse = await fetch("http://localhost:4000/contar/usuarios");
        const maquinasResponse = await fetch("http://localhost:4000/contar/maquinas");
        const mantenimientosResponse = await fetch("http://localhost:4000/contar/mantenimientos");
        const areasResponse = await fetch("http://localhost:4000/contar/areas");
        const lastUsersResponse = await fetch("http://localhost:4000/contar/nuevousuario");
