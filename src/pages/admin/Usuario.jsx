...
const Usuario = () => {
  ...
  const handleActualizarUsuario = async () => {
    ...
    const response = await fetch(`http://localhost:4000/usuario/actualizar/${usuarioActualizado.id_usuario}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
      },
    ...
    <div className='w-full h-20 bg-customBlue flex items-center justify-between px-4'>
      <div>
        <input
          ...
          className="w-48 h-10 border border-gray-300 rounded px-3 py-2 text-stone-950"
