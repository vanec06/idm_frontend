        ...
        <table className="w-3/5 border-none shadow-sm overflow-hidden mx-auto">
          <thead className="bg-customBlue text-white">
            <tr>
              ...
              <th className="py-2 px-3 text-sm">Nombre Área</th>
              <th className="py-2 px-3 text-sm">Nombre Ambiente</th>
          ...
          <tbody className="text-sm text-black bg-white divide-y divide-gray-200">
            {maquinas.map((maquina) => (
              <tr key={maquina.id_maquina}>
                ...
                <td className="py-1 px-3">{maquina.nombre_maquina}</td>
                ...
                <td className="py-1 px-3">{maquina.nombre_usuario}</td>
                <td className="py-1 px-3">{maquina.nombre_area}</td>
                <td className="py-1 px-3">{maquina.nombre_ambiente}</td>
                <td className="py-1 px-3">{maquina.estado_maquina}</td>
